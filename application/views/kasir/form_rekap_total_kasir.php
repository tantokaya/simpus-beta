...
<div class="rightpanel">
    ...
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman laporan rekap pemasukan</span>
    </div><!--pagetitle-->
            	...
            	<div class="span12">
					<div id="tabs">
                        ...
                        <!---- CETAK register START ---->
   						<div id="list">
                        	<h4 class="widgettitle nomargin shadowed">Rekap Total Pembayaran</h4>
                            <div class="widgetcontent bordered shadowed nopadding">
                                <?php echo form_open('cont_cetak_lap_kasir/rekap_pembayaran/cetak', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
