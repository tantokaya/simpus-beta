...
<div class="rightpanel">
    ...
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman manajemen Stok Awal Gudang</span>
    </div><!--pagetitle-->
    	...
    	<div class="contentinner content-dashboard">
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
                    <ul>
                        <?php if(isset($edit_stok_awal_gudang)):?>
                        ...
                        <?php if(isset($edit_stok_awal_gudang)):?>
                            <div id="ubah">
                                ...
                                <div class="row-fluid">
                                    <?php foreach ($edit_stok_awal_gudang as $row): ?>
                                    <?php echo form_open('barang/sawal_gudang/ubah/do_update/'.$row['sawal_code'], array('class' => 'stdform stdform2', 'id' => 'form')); ?>
                                    <div class="span6">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center">
                                            <a href="<?php echo base_url(); ?>barang/sawal_gudang/tambah">	<button type="button"  name="baru"  class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Baru</button> </a>
                                            <button type="button" name="cetak" id="cetak" class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Cetak</button>
                                            <a href="<?php echo base_url(); ?>barang/sawal_gudang">
                                ...
                                foreach ($stok_awal_gudang as $r):
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center" width="15%">
                                            <a href="<?php  echo base_url(); ?>barang/sawal_gudang/ubah/<?php  echo $r['sawal_code']; ?>" class="btn btn-primary btn-circle" title="Edit">
                                                <i class="iconsweets-create iconsweets-white"></i>
                                            </a>
                                            <a href="<?php  echo base_url(); ?>barang/sawal_gudang/hapus/<?php  echo $r['sawal_code']; ?>" class="btn btn-danger btn-circle" onClick="return confirm('Anda yakin ingin mengurangi data ini?')" title="Hapus !">
                        ...
                        <!---- END DAFTAR OBAT---->
                        <!---- TAMBAH OBAT AWAL GUDANG START ---->
						<?php if(isset($tambah_stok_awal)):?>
                        <div id="tambah">
						<h4 class="widgettitle">..:: Form Tambah Stok Awal Gudang ::..</h4>
						<form id="form">
                        <div class="row-fluid">
...
<!--									<button type="button" name="cetak" id="cetak" class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Cetak</button>-->
						...
						<!---- END TAMBAH OBAT STOK AWAL GUDANG ----> 
...
//                $("#jml").focus();
    ...
    function detailBarang(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/DataDetailSawalGudang",
            data	: string,
            cache	: false,
            success	: function(data){
...
/////////////////////////* SIMPAN *////////////////////////////
    $("#simpan").click(function(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/simpan_sawal_gudang",
            data	: string,
            cache	: false,
            success	: function(data){
