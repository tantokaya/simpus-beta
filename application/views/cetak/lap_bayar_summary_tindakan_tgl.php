...
<div class="rightpanel">
 ...
 <div class="breadcrumbwidget">
	 ...
	 <div class="contentinner content-dashboard">
      ...
      <h4 class="widgettitle" >Laporan Summary Transaksi Tindakan</h4>
    <div class="wizard" >
    <form name="my-form" >
...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>c_lap_summary_bayar_tindakan/lihat",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>c_lap_summary_bayar_tindakan/cetak/'+string);	
	});
