...
$judul_H = "LAPORAN BARANG MASUK DETAIL - GUDANG";
...
<?php
    ...
    <tr>
      ...
      <td width="70" align="center"><?php echo $dp['kd_masuk']; ?></td>
      <td width="130" align="center"><?php echo $tgl; ?></td>
      <td width="80"><?php echo $dp['kd_milik_obat']; ?></td>
      <td width="60" align="center"><?php echo $dp['kd_obat']; ?></td>
