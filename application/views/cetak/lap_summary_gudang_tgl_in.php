...
<div class="rightpanel">
 ...
 <div class="breadcrumbwidget">
	 ...
	 <div class="contentinner content-dashboard">
      ...
      <h4 class="widgettitle" >Laporan Summary Transaksi Barang Masuk Gudang</h4>
    <div class="wizard" >
    <form name="my-form" >
...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>barang/lihat_sum_gudang_in",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>barang/cetak_sum_gudang_in/'+string);	
	});
