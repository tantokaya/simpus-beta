...
//        $jml = $jml;
	...
	<tr>
            ...
            <td align="right"><?php echo $db['jml']; ?>  <?php echo $db['sat_kecil_obat'];?></td>
        </tr>
        <?php
        $no++;
    }
    ...
    <div class="page" >
        ...
        <table>
            ...
            <tr>
                <td>Umur</td><td>:</td><td><?php echo $umur; ?> Thn</td>
            </tr>
            <tr>
                <td>Alamat</td><td>:</td><td><?php echo $alamat; ?>,<?php echo $nm_kota; ?></td>
            </tr>
            <tr>
                <td>Status Psn</td><td>:</td><td><?php echo $kd_bayar; ?></td>
            </tr>
        </table>
    </div>
<?php
