...
<?php
	...
	$total = $dp['jml'];
	$item = $this->m_crud->ItemIn($dp['kd_masuk']);
	$jmlIn = $this->m_crud->JmlInSum($dp['kd_masuk']);
    ...
    <tr>
      ...
      <td width="50" align="center"><?php echo $dp['kd_masuk']; ?></td>
      <td width="80" align="center"><?php echo $tgl; ?></td>
      <td width="200"><?php echo $dp['kd_milik_obat']; ?></td>
      <td width="100" align="center"><?php echo number_format($item); ?></td>
      <td width="100" align="right"><?php echo number_format($jmlIn); ?></td>
