    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="widgeticons row-fluid">
                <li class="one_fifth"><a href="<?php echo base_url(); ?>barang/apotek_masuk/tambah"><img src="<?php echo base_url(); ?>assets/img/gemicon/apotek_plus.png" alt="" /><span>Barang Masuk <br>APOTEK</span></a></li>
                <li class="one_fifth"><a href="<?php echo base_url(); ?>barang/apotek_keluar/tambah"><img src="<?php echo base_url(); ?>assets/img/gemicon/apotek_minus.png" alt="" /><span>Barang Keluar <br>APOTEK</span></a></li>
                <li class="one_fifth">
