...
<div class="breadcrumbwidget">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Master Satuan Kecil Obat</a><span class="divider">/</span>
        </li>
        <li class="active">
            <?php echo $page_title; ?>
        </li>
...
<div class="pagetitle">
    ...
    <span>
      Halaman manajemen data satuan kecil obat
    </span>
</div>
<!--pagetitle-->
                    ...
                    <ul>
                        <?php if(isset($edit_satuan_kecil)):?>
                            <li class="ui-tabs-active">
                                <a href="#ubah"><i class="icon-edit"></i>Ubah Data Satuan Kecil Obat</a>
                            </li>
                        <?php endif;?>

                        <li class="<?php if(!isset($edit_satuan_kecil))echo 'ui-tabs-active';?>">
                            <a href="#list"><i class="icon-align-justify"></i>Daftar Satuan Kecil Obat</a>
                        </li>
                        <li class="">
                            <a href="#tambah"><i class="icon-plus"></i>Tambah Satuan Kecil Obat</a>
                        </li>
                    </ul>
                                    ...
                                    <?php foreach ($edit_satuan_kecil as $row): ?>
                                        ...
                                        <table class="table table-bordered table-invoice">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="kd_sat_kecil_obat" id="kd_sat_kecil_obat" value="<?php echo $row['kd_sat_kecil_obat']; ?>" class="input-small" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Nama Satuan</td>
                                                <td>
                                                    <input type="text" name="sat_kecil_obat" id="sat_kecil_obat" value="<?php echo $row['sat_kecil_obat']; ?>" class="input-large" />
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <div class="span6">
                                ...
                                <table class="table table-bordered table-invoice">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="kd_sat_kecil_obat" id="kd_sat_kecil_obat" class="input-small" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama Satuan</td>
                                        <td>
                                            <input type="text" name="sat_kecil_obat" id="sat_kecil_obat" class="input-large" />
                                        </td>
                                    </tr>
                                </table>
                                <p class="stdformbutton">
