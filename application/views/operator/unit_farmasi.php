...
<div class="rightpanel">
    	...
    	<div class="contentinner content-dashboard">
			...
			<?php foreach ($edit_unit_farmasi as $row): ?>
				...
				<tr>
					...
					<td><input type="text" name="kd_unit_farmasi" id="kd_unit_farmasi" value="<?php echo $row['kd_unit_farmasi']; ?>" class="input-small" readonly /></td>
				</tr>
				<tr>
  ...
  <!-- <input type="text" name="kd_unit_farmasi" id="kd_unit_farmasi" class="input-small" />
                    ...
                    <select name="kd_unit_farmasi" id="kd_unit_farmasi" class="uniform-select" required>
                    <option value="">Pilih Kode</option>
                     <option value="APT">Apotek</option>
                     <option value="GU">Gudang Utama</option>
                     <option value="Pustu1">Pustu 1</option>
                     <option value="Pustu2">Pustu 2</option>
                     <option value="Pustu3">Pustu 3</option>
                     <option value="Pustu4">Pustu 4</option>
                     <option value="Poli1">Poli 1</option>
                     <option value="Poli2">Poli 2</option>
			<option value="Poli3">Poli 3</option>
                     <option value="Poli4">Poli 4</option>
			<option value="Poli5">Poli 5</option>
                     <option value="Poli6">Poli 6</option>
