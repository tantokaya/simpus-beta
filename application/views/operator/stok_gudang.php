            	...
            	<div class="span12">
					<div id="tabs">
  	 					<ul>
                            ...
                            <li class="<?php if(!isset($edit_obat))echo 'ui-tabs-active';?>"><a href="#list"><i class="icon-align-justify"></i> Daftar Stok Obat Gudang</a></li>
                            </ul>
							...
							<script type="text/javascript">
                                jQuery(document).ready(function () {
                                    var oTable = jQuery('#dyntable').dataTable({
                                        "bProcessing": true,
                                        "bServerSide": true,
                                        "sAjaxSource": '<?php echo base_url(); ?>datatable_master/obat_gudang_stok',
                                        "bJQueryUI": false,
