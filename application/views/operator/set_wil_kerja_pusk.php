...
<div class="pagetitle">
    ...
    <span>
      Halaman manajemen data wilayah kerja puskesmas
    </span>
</div>
<!--pagetitle-->
...
<div id="tabs">
<ul>
    <?php if(isset($edit_wilker)):?>
        <li class="ui-tabs-active">
            <a href="#ubah">
                <i class="icon-edit"></i>
                Ubah Data Wilayah Kerja
            </a>
        </li>
    <?php endif;?>

    <li class="<?php if(!isset($edit_wilker))echo 'ui-tabs-active';?>">
        <a href="#list">
...
<?php if(isset($edit_pengguna)):?>
    <div id="ubah">
        ...
        <div class="row-fluid">
            <div class="span12">
            <?php foreach ($edit_wilker as $row): ?>
                <?php echo form_open('cont_master_setting/set_wil_kerja_pusk/ubah/do_update/'.$row['id'], array('class' =>'stdform stdform2', 'id' =>'form_edit')); ?>
                <table class="table table-bordered table-invoice">  
                  
                    <tr>
                        <td>Nama Kelurahan/Desa</td>
                        <td>
                            <select name="kd_kelurahan" id="kd_kelurahan2" data-placeholder="Pilih Kelurahan/Desa" style="width:350px" class="uniform-select" required>
                                <option value="">
                                </option>
                    ...
                    <tr>
                        <td>Username</td>
                        <td><input type="text" name="username" id="username" class="input-medium" value="<?php echo $row['username'] ?>" ></td>
                    </tr>
                    <tr>
                        <td>E-mail</td>
                        <td>
                            <input type="text" name="email" id="email2" class="input-large" value="<?php echo $row['email'] ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>Password</td>
                ...
                <p class="stdformbutton">
                    <button class="btn btn-primary btn-rounded">
                        <i class="icon-ok icon-white"></i>Perbarui</button>
