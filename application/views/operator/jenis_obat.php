...
<div class="breadcrumbwidget">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Master Jenis Obat</a><span class="divider">/</span>
        </li>
        <li class="active">
            <?php echo $page_title; ?>
        </li>
...
<div class="pagetitle">
    ...
    <span>Halaman manajemen data jenis obat</span>
</div>
<!--pagetitle-->
                    ...
                    <ul>
                        <?php if(isset($edit_jenis_obat)):?>
                            <li class="ui-tabs-active">
                                <a href="#ubah"><i class="icon-edit"></i>Ubah Data Jenis Obat</a>
                            </li>
                        <?php endif;?>

                        <li class="<?php if(!isset($edit_jenis_obat))echo 'ui-tabs-active';?>">
                            <a href="#list"><i class="icon-align-justify"></i>Daftar Jenis Obat</a>
                        </li>
                        <li class="">
                            <a href="#tambah"><i class="icon-plus"></i>Tambah Jenis Obat</a>
                        </li>
                    </ul>
                                    ...
                                    <?php foreach ($edit_jenis_obat as $row): ?>
                                        ...
                                        <table class="table table-bordered table-invoice">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="kd_jenis_obat" id="kd_jenis_obat" value="<?php echo $row['kd_jenis_obat']; ?>" class="input-medium" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Obat</td>
                                                <td>
                                                    <input type="text" name="jenis_obat" id="jenis_obat" value="<?php echo $row['jenis_obat']; ?>" class="input-large" />
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <div class="span6">
                                ...
                                <table class="table table-bordered table-invoice">
                                    <tr>
                                        <td>Kode Jenis Obat</td>
                                        <td>
                                            <input type="text" name="kd_jenis_obat" id="kd_jenis_obat" class="input-medium" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Obat</td>
                                        <td>
                                            <input type="text" name="jenis_obat" id="jenis_obat" class="input-large" />
                                        </td>
                                    </tr>
