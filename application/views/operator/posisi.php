        	...
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
        				...
        				<?php if(isset($edit_posisi)):?>
                        <div id="ubah">
                       		<h4 class="widgettitle">Ubah Data Posisi</h4>
                            <div class="row-fluid">
                                <div class="span6">
                            <?php foreach ($edit_posisi as $row): ?>
                            	<?php echo form_open('cont_master_petugas/posisi/ubah/do_update/'.$row['kd_posisi'], array('class' => 'stdform stdform2', 'id' => 'form_edit')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Posisi</td>
                                            <td><input type="text" name="kd_posisi" id="kd_posisi" value="<?php echo $row['kd_posisi']; ?>" class="input-small" /></td>
                                        </tr>
                                        <tr>
                                            <td>Posisi</td>
                                            <td><input type="text" name="posisi" id="posisi" value="<?php echo $row['posisi']; ?>" class="input-medium" /></td>
                                        </tr>
                                    </table>
                        ...
                        <!---- TAMBAH POSISI START ---->
                        <div id="tambah">
                       		<h4 class="widgettitle">Data Posisi</h4>
                            <div class="row-fluid">
                                <div class="span6">
                                <?php echo form_open('cont_master_petugas/posisi/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Posisi</td>
                                            <td><input type="text" name="kd_posisi" id="kd_posisi" class="input-small" /></td>
                                        </tr>
                                        <tr>
                                            <td>Posisi</td>
                                            <td><input type="text" name="kd_posisi" id="kd_posisi" class="input-medium" /></td>
                                        </tr>
                                    </table>
                                    <p class="stdformbutton">
