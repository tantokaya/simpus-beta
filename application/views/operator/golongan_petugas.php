        	...
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
        				...
        				<?php if(isset($edit_golongan_petugas)):?>
                        <div id="ubah">
                       		<h4 class="widgettitle">Ubah Data Golongan Petugas</h4>
                            <div class="row-fluid">
                                <div class="span6">
                            <?php foreach ($edit_golongan_petugas as $row): ?>
                            	<?php echo form_open('cont_master_petugas/golongan_petugas/ubah/do_update/'.$row['kd_gol'], array('class' => 'stdform stdform2', 'id' => 'form_edit')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Golongan Petugas</td>
                                            <td><input type="text" name="kd_gol" id="kd_gol" value="<?php echo $row['kd_gol']; ?>" class="input-small" /></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Golongan</td>
                                            <td><input type="text" name="nama_gol" id="nama_gol" value="<?php echo $row['nama_gol']; ?>" class="input-medium" /></td>
                                        </tr>
                                    </table>                                <p>
                        ...
                        <div id="tambah">
                       		<h4 class="widgettitle">Data Golongan Petugas</h4>
                            <div class="row-fluid">
                                <div class="span6">
                                <?php echo form_open('cont_master_petugas/golongan_petugas/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Golongan Petugas</td>
                                            <td><input type="text" name="kd_gol" id="kd_gol" class="input-medium" /></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Golongan Petugas</td>
                                            <td><input type="text" name="nama_gol" id="nama_gol" class="input-large" /></td>
                                        </tr>
                                    </table>
