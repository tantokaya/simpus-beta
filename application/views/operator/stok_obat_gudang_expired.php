...
<div class="rightpanel">
	...
	<div id="tabs">
  	<ul>
		<li class="ui-tabs-active"><a href="#daftar"><i class="icon-align-justify"></i> Daftar Stok Obat Gudang Expired</a></li>
	</ul>
	
	<div id="daftar">
		<h4 class="widgettitle">..:: Tampil Stok Data Obat Gudang Expired ::..</h4>
        <div class="row-fluid">
	<!--<div class="span6">-->
	<form id="form">
...
$(document).ready(function(){
	...
	function DetailBarang(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>barang/lihat_expired",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>barang/cetak_obat_gudang_expired/'+string);
		return false();
	});
});	
</script>