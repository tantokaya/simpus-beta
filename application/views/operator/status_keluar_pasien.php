        	...
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
        				...
        				<?php if(isset($edit_status_keluar_pasien)):?>
                        <div id="ubah">
                       		<h4 class="widgettitle">Ubah Data Status Keluar Pasien</h4>
                            <div class="row-fluid">
                                <div class="span6">
                            	...
                            	<?php echo form_open('cont_master_pelayanan/status_keluar_pasien/ubah/do_update/'.$row['kd_status_pasien'], array('class' => 'stdform stdform2', 'id' => 'form_edit')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Status</td>
                                            <td><input type="text" name="kd_status_pasien" id="kd_status_pasien" value="<?php echo $row['kd_status_pasien']; ?>" class="input-small" /></td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan</td>
                                            <td><input type="text" name="keterangan" id="keterangan" value="<?php echo $row['keterangan']; ?>" class="input-xlarge" /></td>
                                        </tr>
                                    </table>
                        ...
                        <div id="tambah">
                       		<h4 class="widgettitle">Data Status Keluar Pasien</h4>
                            <div class="row-fluid">
                                <div class="span6">
                                <?php echo form_open('cont_master_pelayanan/status_keluar_pasien/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                    <table class="table table-bordered table-invoice">
                                        <tr>
                                            <td>Kode Status</td>
                                            <td><input type="text" name="kd_status_pasien" id="kd_status_pasien" class="input-small" /></td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan</td>
                                            <td><input type="text" name="keterangan" id="keterangan" class="input-xlarge" /></td>
                                        </tr>
                                    </table>
                                    <p class="stdformbutton">
