...
<div class="rightpanel">
	...
	<div id="tabs">
  	<ul>
		<li class="ui-tabs-active"><a href="#daftar"><i class="icon-align-justify"></i> Daftar Stok Obat Apotek</a></li>
	</ul>
	
	<div id="daftar">
		<h4 class="widgettitle">..:: Tampil Stok Data Obat Apotek ::..</h4>
        <div class="row-fluid">
	<!--<div class="span6">-->
	<form id="form">
...
$(document).ready(function(){
	...
	function DetailBarang(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>barang/lihat_stok_apotek",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>barang/cetak_obat_apotek/'+string);
		return false();
	});
});	
</script>