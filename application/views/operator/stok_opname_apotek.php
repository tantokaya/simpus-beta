...
<div class="rightpanel">
    ...
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman manajemen Stok Opname Apotek</span>
    </div><!--pagetitle-->
    ...
    <div class="maincontent">
    	<div class="contentinner content-dashboard">
            	...
            	<div class="span12">
					<div id="tabs">
  	 					<ul>
            				...
            				<li class="ui-tabs-active"><a href="#ubah"><i class="icon-edit"></i> Ubah Data Stok Opname Apotek</a></li>
            				<?php endif;?>
							
                        	<?php if(isset($tambah_stok_opname)):?>
            				<li class=""><a href="#tambah"><i class="icon-edit"></i> Stok Opname Apotek</a></li>
            				<?php endif;?>
      						
                            <li class="<?php if(!isset($tambah_stok_opname))echo 'ui-tabs-active';?>">
                                <a href="#list"><i class="icon-align-justify"></i> Daftar Stok Opname Apotek</a>
                            </li>
                        </ul>
                        ...
                        <div id="ubah">
							...
							<?php foreach ($edit_stok_opname as $row): ?>
                            	<?php echo form_open('barang/sopname_apotek/ubah/do_update/'.$row['opname_code'], array('class' => 'stdform stdform2', 'id' => 'form')); ?>
                                <div class="span6">
						  ...
						  <table class="table table-bordered table-invoice">
							...
							<div class="clearfix"><br /> </div>
                                <table width="100%">
								    <tr>
										<td align="center">
											<a href="<?php echo base_url(); ?>barang/sopname_apotek/tambah">	<button type="button"  name="baru"  class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Baru</button> </a>
											<button type="button" name="cetak" id="cetak" class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Cetak</button>
											<a href="<?php echo base_url(); ?>barang/sopname_apotek">
			...
			<div class="clearfix"><br /> </div>
							...
							<div id="DataBarangApotek" title="Data Barang Apotek">
                        ...
                        <div id="list">
                            <a href="<?php  echo base_url(); ?>barang/sopname_apotek/tambah">
                            ...
                            <table class="table table-bordered" id="dyntable">
                                ...
                                <?php
                                $no=1;
                                foreach ($opname_apotek as $r):
                                    $itemOpname = $this->m_crud->OpnameApotekRec($r['opname_code']);
                                    ?>
                                    <tr class="gradeX">
                                        ...
                                        <td class="center" width="15%">
                                            <a href="<?php  echo base_url(); ?>barang/sopname_apotek/ubah/<?php  echo $r['opname_code']; ?>" class="btn btn-primary btn-circle" title="Edit">
                                                <i class="iconsweets-create iconsweets-white"></i>
                                            </a>
                                            <a href="<?php  echo base_url(); ?>barang/sopname_apotek/hapus/<?php  echo $r['opname_code']; ?>" class="btn btn-danger btn-circle" onClick="return confirm('Anda yakin ingin mengurangi data ini?')" title="Hapus !">
                        ...
                        <!---- TAMBAH OBAT OPNAME APOTEK START ---->
						<?php if(isset($tambah_stok_opname)):?>
                        <div id="tambah">
						<h4 class="widgettitle">..:: Form Tambah Stok Opname Apotek ::..</h4>
						<div class="row-fluid">
...
/////////////////////* SCRIPT PENCARIAN KODE BARANG *//////////////////////////////////
    ...
    function detailBarang(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/DataDetailOpnameApotek",
            data	: string,
            cache	: false,
            success	: function(data){
...
/////////////////////////* SIMPAN *////////////////////////////
    $("#simpan").click(function(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/simpan_stok_opname_apotek",
            data	: string,
            cache	: false,
            success	: function(data){
	...
	$("#cetak").click(function(){
		var kode	= $("#code").val();
		window.open('<?php echo site_url();?>barang/cetak_stok_opname_apotek/'+kode);
		return false();
	});
