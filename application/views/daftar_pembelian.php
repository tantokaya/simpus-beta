...
<tbody>    
  <tr>
      ...
      <td><center><?php echo number_format($dp['harga_beli']); ?></center></td>
      <td><center><?php echo number_format($total); ?></center></td>
      <td width="100">
      <div class="btn-group">
        <a class="btn btn-danger" href="<?php echo base_url();?>index.php/barang/HapusDetail/<?php echo $dp['kd_masuk'];?>/<?php echo $dp['kd_obat'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="icon-trash icon-white"></i></a>
      </div><!-- /btn-group -->
	  </td>
  </tr>
