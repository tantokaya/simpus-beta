...
<div class="rightpanel">
	<div class="breadcrumbwidget">
    	<ul class="breadcrumb">
            ...
            <li><a href="#">Master Milik Obat</a> <span class="divider">/</span></li>
            <li class="active"><?php echo $page_title; ?></li>
        </ul>
	</div><!--breadcrumbwidget-->
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman manajemen data milik obat</span>
    </div><!--pagetitle-->
    	...
    	<div class="contentinner content-dashboard">
            	...
            	<div class="span12">
					<div id="tabs">
  	 					<ul>
            				...
            				<li class="ui-tabs-active"><a href="#ubah"><i class="icon-edit"></i> Ubah Data Milik Obat</a></li>
            				<?php endif;?>
      						
                            <li class="<?php if(!isset($edit_milik_obat))echo 'ui-tabs-active';?>"><a href="#list"><i class="icon-align-justify"></i> Daftar Milik Obat</a></li>
                            <li class=""><a href="#tambah"><i class="icon-plus"></i> Tambah Milik Obat</a></li>
                        </ul>
			...
			<?php foreach ($edit_milik_obat as $row): ?>
				...
				<tr>
					...
					<td><input type="text" name="kd_milik_obat" id="kd_milik_obat" value="<?php echo $row['kd_milik_obat']; ?>" class="input-medium" /></td>
				</tr>
				<tr>
					<td>Kepemilikian</td>
					<td><input type="text" name="kepemilikan" id="kepemilikan" value="<?php echo $row['kepemilikan']; ?>" class="input-large" /></td>
				</tr>
			</table>
			...
			<div class="span6">
				...
				<tr>
					<td>Kode Milik Obat</td>
					<td><input type="text" name="kd_milik_obat" id="kd_milik_obat" class="input-medium" /></td>
				</tr>
				<tr>
					<td>Kepemilikan</td>
					<td><input type="text" name="kepemilikan" id="kepemilikan" class="input-large" /></td>
				</tr>
			</table>
			<p class="stdformbutton">
