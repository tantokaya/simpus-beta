        	...
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
        				...
        				<?php if(isset($edit_petugas)):?>
                        <div id="ubah">
                       		<h4 class="widgettitle nomargin shadowed">Ubah Data Petugas</h4>
                            ...
                            <?php foreach ($edit_petugas as $row): ?>
                            	<?php echo form_open('cont_master_pelayanan/petugas/ubah/do_update/'.$row['kd_petugas'], array('class' => 'stdform stdform2', 'id' => 'form_edit')); ?>
                                        <p>
                                            ...
                                            <span class="field"><input type="text" name="kd_petugas" id="kd_petugas" value="<?php echo $row['kd_petugas']; ?>" class="input-xxlarge" /></span>
                                        </p>
										
										<p>
                                            <label>Nama Petugas *</label>
                                            <span class="field"><input type="text" name="nama_petugas" id="nama_petugas" value="<?php echo $row['nama_petugas']; ?>" class="input-xxlarge" /></span>
                                        </p>  
                                        ...
                                        <p> <label> * Field harus diisi </label>
                                        </p>
                        ...
                        <div id="tambah">
                       		<h4 class="widgettitle nomargin shadowed">Data Petugas</h4>
                            <div class="widgetcontent bordered shadowed nopadding">
                                <?php echo form_open('cont_master_pelayanan/petugas/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                        <p>
                                            <label>Kode Petugas *</label>
                                            <span class="field"><input type="text" name="kd_petugas" id="kd_petugas" class="input-xxlarge" /></span>
                                        </p>
										
										<p>
                                            <label>Nama Petugas *</label>
                                            <span class="field"><input type="text" name="nama_petugas" id="nama_petugas" class="input-xxlarge"/></span>
                                        </p>
