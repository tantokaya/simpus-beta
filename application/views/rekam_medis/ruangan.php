                            ...
                            <?php foreach ($edit_ruangan as $row): ?>
                             ...
                             <!--           <p>
										...
										<p>
                                            ...
                                            <span class="field"><input type="text" name="jml_kmr" id="jml_kmr" value="<?php echo $row['jml_kmr']; ?>" class="input-xxlarge" /></span>
                                        </p>
                            ...
                            <div class="widgetcontent bordered shadowed nopadding">
                                <?php echo form_open('cont_master_pelayanan/ruangan/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                    ...
                                    <!--    
                                        ...
                                        <p>
                                            <label>Jumlah Kamar</label>
                                            <span class="field"><input type="text" name="jml_kmr" id="jml_kmr" class="input-xxlarge" /></span>
                                        </p>		
