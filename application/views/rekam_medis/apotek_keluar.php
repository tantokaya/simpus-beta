    ...
    <div class="maincontent">
    	<div class="contentinner content-dashboard">
			...
			<!--<input type="text" style="width:100px; font-size: 15px; " name="kd_resep" id="kd_obat" value="" placeholder="..." />	-->
                                ...
                                <table width="100%">
								    <tr>
										...
										<a href="<?php echo base_url(); ?>barang/apotek_keluar/tambah">	<button type="button"  name="baru"  class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Baru</button> </a>	
											...
											<a href="<?php echo base_url(); ?>barang/apotek_keluar">
                        ...
                        <!---- DAFTAR OBAT START ---->
   						<div id="list">
                        	<a href="<?php echo base_url(); ?>barang/apotek_keluar/tambah"> 
							<button class="btn btn-warning btn-rounded" title="Tambah Stok Obat Apotek"><i class="icon-plus icon-white"></i> Tambah </button></a> 
							<a href="<?php echo base_url(); ?>barang/apotek_keluar"> 
				    ...
				    <!--<th class="head1 center">Stok Akhir</th>-->
                                    <!--<th class="head0 center">Penerima</th>-->
						...
						<form id="form">
						  ...
						  <table class="table table-bordered table-invoice">
							...
							<!-- <tr>
								<td>ID Pasien</td>
								<td></td>
								<td><button type="button" name="list_pasien" id="list_pasien" class="btn btn-danger btn-small" title="Cari Pasien"><i class="icon-list-alt icon-white"></i></button></td>
							 </tr>--> 
							 <!--<tr>
								<td>Nama Pasien</td>
