                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                    ...
                                    <tr>
                                        <td>Jenis Kelamin *</td>
                                        <td>
                                        	<select name="kd_jenis_kelamin" id="kd_jenis_kelamin2" class="chzn-select">
<!--                                                <option value=""></option>-->
                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                    ...
                                    <tr>
                                    	<td>Propinsi *</td>
                                        <td>
                                        	<select name="kd_propinsi" id="kd_propinsi2" style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<select name="kd_kota" id="kd_kota2" style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                    ...
                                    <tr>
                                        <td>Kecamatan *</td>
                                        <td>
                                        	<select name="kd_kecamatan" id="kd_kecamatan2" style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                    ...
                                    <tr>
                                        <td>Kelurahan *</td>
                                        <td>
                                        	<select name="kd_kelurahan" id="kd_kelurahan2" style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                        ...
                        <?php echo form_open('cont_transaksi_pendaftaran/pendaftaran/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                    ...
                                    <tr>
                                        <td>Jenis Kelamin *</td>
                                        <td>
                                        	<select name="kd_jenis_kelamin" id="kd_jenis_kelamin" class="chzn-select">
                                                <option value=""></option>
                                                <?php foreach($list_jenis_kelamin as $jk) : ?>
                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                    ...
                                    <tr>
                                    	<td>Propinsi *</td>
                                        <td>
                                        	<select name="kd_propinsi" id="kd_propinsi"  style="width:250px" class="chzn-select" tabindex="2" required>
                                            	<option value=""></option>
                                            	<?php foreach($list_provinsi as $lp) : ?>
												<option value="<?php echo $lp['kd_propinsi']; ?>"><?php echo $lp['nm_propinsi']; ?></option>
                                    ...
                                    <tr>
                                    	<td>Kota / Kabupaten *</td>
                                        <td>
                                        	<select name="kd_kota" id="kd_kota"  style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                    ...
                                    <tr>
                                        <td>Kecamatan *</td>
                                        <td>
                                        	<select name="kd_kecamatan" id="kd_kecamatan"  style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                    ...
                                    <tr>
                                        <td>Kelurahan *</td>
                                        <td>
                                        	<select name="kd_kelurahan" id="kd_kelurahan"  style="width:250px" class="chzn-select" required>
                                            	<option value=""></option>
                                            </select>
                                        </td>
                                    </tr>
                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                    ...
                                    <tr>
                                    	<td>Agama</td>
                                        <td>
                                        	<select name="kd_agama" id="kd_agama"  style="width:250px" class="chzn-select" required>
                                            <option value=""></option>
                                            <?php foreach($list_agama as $la) : ?>
                                            	<option value="<?php echo $la['kd_agama']; ?>"><?php echo $la['nm_agama']; ?></option>
											<?php endforeach; ?>
                                    ...
                                    <tr>
                                    	<td>Golongan Darah</td>
                                        <td>
                                        	<select name="kd_gol_darah" id="kd_gol_darah"  style="width:250px" class="chzn-select" required>
                                           	<option value=""></option>
                                            <?php foreach($list_golongan_darah as $lgd) : ?>
                                            	<option value="<?php echo $lgd['kd_gol_darah']; ?>"><?php echo $lgd['gol_darah']; ?></option>
											<?php endforeach; ?>
                                    ...
                                    <tr>
                                        <td>Pekerjaan</td>
                                        <td>
                                        	 <select name="kd_pekerjaan" id="kd_pekerjaan" style="width:250px" class="chzn-select" required>
                                             	<option value=""></option>
                                            	<?php foreach($list_pekerjaan as $lpk) : ?>
                                            	<option value="<?php echo $lpk['kd_pekerjaan']; ?>"><?php echo $lpk['pekerjaan']; ?></option>
											<?php endforeach; ?>
                            ...
                            <div class="span6">
                            	<table class="table table-bordered table-invoice">
                                	<tr>
                                        <td class="width30">Status Nikah</td>
                                        <td class="width70"><select name="kd_status_marital" id="kd_status_marital"  style="width:250px" class="chzn-select" required>
                                            <option value=""></option>
                                            <?php foreach($list_status_marital as $lsm) : ?>
                                            	<option value="<?php echo $lsm['kd_status_marital']; ?>"><?php echo $lsm['status_marital']; ?></option>
											<?php endforeach; ?>
                                    ...
                                    <tr>
                                    	<td>Pendidikan Akhir</td>
                                        <td>
                                        	<select name="kd_pendidikan" id="kd_pendidikan"  style="width:250px" class="chzn-select" required>
                                            <option value=""></option>
                                            <?php foreach($list_pendidikan as $lp) : ?>
                                            	<option value="<?php echo $lp['kd_pendidikan']; ?>"><?php echo $lp['pendidikan']; ?></option>
											<?php endforeach; ?>
                                ...
                                <div class="row-fluid">
                                	<div class="span12">
                                   		<table class="table table-bordered table-stripped table-hover">
                                            ...
                                            <?php else: ?>
                                            	<tr>
                                                	<td colspan="11" class="center">Tidak ada riwayat kunjungan</td>
                                                </tr>
                                            <?php endif; ?>
                                            </tbody>
                                        </table>
