...
<div class="rightpanel">
	<div class="breadcrumbwidget">
    	<ul class="breadcrumb">
            ...
            <li><a href="#">Master Terapi Obat</a> <span class="divider">/</span></li>
            <li class="active"><?php echo $page_title; ?></li>
        </ul>
	</div><!--breadcrumbwidget-->
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman manajemen data terapi obat</span>
    </div><!--pagetitle-->
    	...
    	<div class="contentinner content-dashboard">
            	...
            	<div class="span12">
					<div id="tabs">
  	 					<ul>
            				...
            				<li class="ui-tabs-active"><a href="#ubah"><i class="icon-edit"></i> Ubah Data Terapi Obat</a></li>
            				<?php endif;?>
      						
                            <li class="<?php if(!isset($edit_terapi_obat))echo 'ui-tabs-active';?>"><a href="#list"><i class="icon-align-justify"></i> Daftar Terapi Obat</a></li>
                            <li class=""><a href="#tambah"><i class="icon-plus"></i> Tambah Terapi Obat</a></li>
                        </ul>
                        
                        <!----EDITING FORM STARTS---->
        				<?php if(isset($edit_terapi_obat)):?>
                        <div id="ubah">
                       	<h4 class="widgettitle">Ubah Data Terapi Obat</h4>
                        <div class="row-fluid">
			<div class="span6">
			<?php foreach ($edit_terapi_obat as $row): ?>
				...
				<tr>
					...
					<td><input type="text" name="kd_terapi_obat" id="kd_terapi_obat" value="<?php echo $row['kd_terapi_obat']; ?>" class="input-small" /></td>
				</tr>
				<tr>
					<td>Terapi Obat</td>
					<td><input type="text" name="terapi_obat" id="terapi_obat" value="<?php echo $row['terapi_obat']; ?>" class="input-large" /></td>
				</tr>
			</table>
			...
			<?php echo form_close(); ?>
                        ...
                        <div id="tambah">
                       	<h4 class="widgettitle">Data Terapi Obat</h4>
                        <div class="row-fluid">
			<div class="span6">
			<?php echo form_open('cont_master_farmasi/terapi_obat/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
				...
				<tr>
					<td>Kode Terapi Obat</td>
					<td><input type="text" name="kd_terapi_obat" id="kd_terapi_obat" class="input-small" /></td>
				</tr>
				<tr>
					<td>Terapi Obat</td>
					<td><input type="text" name="terapi_obat" id="terapi_obat" class="input-large" /></td>
				</tr>
			</table>
			<p class="stdformbutton">
