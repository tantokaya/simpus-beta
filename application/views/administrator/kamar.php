                            ...
                            <?php foreach ($edit_kamar as $row): ?>
                            	<?php echo form_open('cont_master_pelayanan/kamar/ubah/do_update/'.$row['kd_kamar'], array('class' => 'stdform stdform2', 'id' => 'form_edit')); ?>
                                        <p>
                                            ...
                                            <span class="field"><input type="text" name="kd_kamar" id="kd_kamar" value="<?php echo $row['kd_kamar']; ?>" class="input-xxlarge" /></span>
                                        </p>
                                        
                                        <p>
                                            <label>No Kamar</label>
                                            <span class="field"><input type="text" name="no_kamar" id="no_kamar" value="<?php echo $row['no_kamar']; ?>" class="input-xxlarge" /></span>
                                        </p>
										
										<p>
                                            <label>Nama Ruangan</label>
                                            <span class="field">
											<select name="kd_ruangan" id="kd_ruangan" class="chzn-select" required>
                        ...
                        <div id="tambah">
                            ...
                            <div class="widgetcontent bordered shadowed nopadding">
                                <?php echo form_open('cont_master_pelayanan/kamar/tambah', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                       <p>
                                            <label>Kode Kamar</label>
                                            <span class="field"><input type="text" name="kd_kamar" id="kd_kamar" class="input-xxlarge" /></span>
                                        </p>
                                        
                                        <p>
                                            <label>No Kamar</label>
                                            <span class="field"><input type="text" name="no_kamar" id="no_kamar"  class="input-xxlarge" /></span>
                                        </p>
