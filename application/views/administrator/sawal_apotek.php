...
<div class="rightpanel">
    ...
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman manajemen Stok Awal Apotek</span>
    </div><!--pagetitle-->
    	...
    	<div class="contentinner content-dashboard">
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
                    <ul>
                        <?php if(isset($edit_stok_awal_apotek)):?>
                            <li class="ui-tabs-active"><a href="#ubah"><i class="icon-edit"></i> Ubah Data Stok Awal Obat</a></li>
                        <?php endif;?>

                        <?php if(isset($tambah_stok_awal)):?>
                            <li class=""><a href="#tambah"><i class="icon-edit"></i> Stok Awal Obat</a></li>
                        <?php endif;?>

                        <li class="<?php if(!isset($tambah_stok_awal))echo 'ui-tabs-active';?>"><a href="#list"><i class="icon-align-justify"></i> Daftar Stok Awal</a></li>
                    </ul>

                        <!----EDITING FORM STARTS---->
                        <?php if(isset($edit_stok_awal_apotek)):?>
                            <div id="ubah">
                                <h4 class="widgettitle nomargin shadowed">..:: Form Ubah Data Stok Awal Apotek ::..</h4>
                                <div class="row-fluid">
                                    <?php foreach ($edit_stok_awal_apotek as $row): ?>
                                    <?php echo form_open('barang/sawal_apotek/ubah/do_update/'.$row['sawal_code'], array('class' => 'stdform stdform2', 'id' => 'form')); ?>
                                    <div class="span6">
                                        ...
                                        <form id="form">
                                            <table class="table table-bordered table-invoice">
                                                <tr>
                                                    <td class="width30">Kode Trans :</td>
                                                    <td class="width70"><input type="text" id="code" name="code" readonly value="<?php echo $row['sawal_code']; ?>"  style="width:100px; font-size: 13px;" ></td>
                                                </tr>
                                    ...
                                    <div class="span6">
                                        ...
                                        <table class="table table-bordered table-invoice">
                                            <tr>
                                                <td>Tgl Input Stok Awal</td>
                                                <td><strong><input type="text" name="sawal_tgl"  id="sawal_tgl" value="<?php echo $this->m_crud->tgl_sql($row['sawal_tgl']); ?>"  style="width:100px; font-size: 13px;"  /></strong></td>
                                            </tr>
                                        </table>
                                    </div></div><!--span6-->
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center">
                                            <a href="<?php echo base_url(); ?>barang/sawal_apotek/tambah">	<button type="button"  name="baru"  class="btn btn-inverse"><i class="icon-ok-circle icon-white"></i> Baru</button> </a>
                        ...
                        <!---- DAFTAR OBAT OPNAME APOTEK START ---->
                        <div id="list">
                            ...
                            <a href="<?php  echo base_url(); ?>barang/sawal_apotek">
                            ...
                            <table class="table table-bordered" id="dyntable">
                                ...
                                <tr>
                                    ...
                                    <th class="head1 center">Kode S.Awal</th>
                                    <th class="head0 center">Tgl S.Awal</th>
                                ...
                                <?php
                                $no=1;
                                foreach ($stok_awal_apotek as $r):
                                    $itemAwal = $this->m_crud->itemAwalApotek($r['sawal_code']);
                                    ?>
                                    <tr class="gradeX">
                                        ...
                                        <td class="center" width="15%"><?php  echo $r['sawal_code']; ?></td>
                                        <td class="center" width="13%"><?php  echo $this->m_crud->tgl_sql($r['sawal_tgl']); ?></td>
                                        <td class="center"><?php  echo $itemAwal; ?></td>
                                        <td class="center" width="15%">
                                            <a href="<?php  echo base_url(); ?>barang/sawal_apotek/ubah/<?php  echo $r['sawal_code']; ?>" class="btn btn-primary btn-circle" title="Edit">
                                                <i class="iconsweets-create iconsweets-white"></i>
                                            </a>
                                            <a href="<?php  echo base_url(); ?>barang/sawal_apotek/hapus/<?php  echo $r['sawal_code']; ?>" class="btn btn-danger btn-circle" onClick="return confirm('Anda yakin ingin mengurangi data ini?')" title="Hapus !">
                        ...
                        <!---- END DAFTAR OBAT---->
                        <!---- TAMBAH OBAT AWAL APOTEK START ---->
						<?php if(isset($tambah_stok_awal)):?>
                        <div id="tambah">
						<h4 class="widgettitle">..:: Form Tambah Stok Awal Apotek ::..</h4>
						<form id="form">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <table class="table table-bordered table-invoice">
                                    <tr>
                                        <td>Tgl Input Stok Awal</td>
                                        <td><strong><input type="text" name="sawal_tgl"  id="sawal_tgl" value="<?php echo $sawal_tgl; ?>"  style="width:100px; font-size: 13px;"  /></strong></td>
                                    </tr>
                                </table>
                            </div><!--span6-->
                        </div><!--row-fluid-->
...
//                $("#jml").focus();
    ...
    function detailBarang(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/DataDetailSawalApotek",
            data	: string,
            cache	: false,
            success	: function(data){
...
/////////////////////////* SIMPAN *////////////////////////////
    $("#simpan").click(function(){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>barang/simpan_sawal_apotek",
            data	: string,
            cache	: false,
            success	: function(data){
