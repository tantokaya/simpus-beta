...
<div class="rightpanel">
 ...
 <div class="breadcrumbwidget">
        	<ul class="breadcrumb">
                ...
                <li class="active">Laporan Apotek Masuk Detail per tgl</li>
            </ul>
	 ...
	 <div class="contentinner content-dashboard">
      ...
      <h4 class="widgettitle" >Laporan Transaksi Apotek Masuk Detail</h4>
    <div class="wizard" >
    <form name="my-form" >
...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>barang/lihat_apotek",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>barang/cetak_lap_apotek/'+string);	
	});
