...
<div class="rightpanel">
 ...
 <div class="breadcrumbwidget">
        	<ul class="breadcrumb">
                ...
                <li class="active">Laporan Barang Keluar per tgl</li>
            </ul>
	 ...
	 <div class="contentinner content-dashboard">
      ...
      <h4 class="widgettitle" >Laporan Transaksi Detail Barang Keluar</h4>
    <div class="wizard" >
    <form name="my-form" >
...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>barang/lihat_gudang_out",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>barang/cetak_lap_gudang_out/'+string);	
	});
